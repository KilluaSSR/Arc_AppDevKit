...
import killua.dev.core.baseui.AnimatedTextContainer
import killua.dev.core.data.datastore.readStoreBoolean
import killua.dev.core.data.datastore.saveStoreBoolean
...
fun Switchable(
    ...
    Clickable(
        ...
        trailingContent = {
            HorizontalDivider(
                modifier = Modifier.height(SizeTokens.Level36)
